...
namespace Nop.Core.Domain.Catalog
{
    ...
    public partial class ProductAttributeValue : BaseEntity, ILocalizedEntity
    {
        ...
        /// <summary>
        /// Gets or sets product sku for combination to be generated.
        /// </summary>
        public string ProductSKU { get; set; }

        /// <summary>
        /// Gets or sets product stock for combination to be generated.
        /// </summary>
        public int ProductStock { get; set; }

        /// <summary>
        /// Gets or sets product price for combination to be generated.
        /// </summary>
